                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="form-control supplier select2" name="customerId">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" step=".01" class="form-control price" name="price[]"></td>
